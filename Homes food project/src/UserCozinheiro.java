...
public class UserCozinheiro extends User{
    ...
    public UserCozinheiro (String nome, String user, int senha, String[] cardapio) {
    ...
    public User CadastroCozinheiro() {
    ...
    public User EntrarCozinheiro() {
        ...
        User login = new User(nomeInserido, user, senhaInserida);
